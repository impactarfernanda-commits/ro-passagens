-- Corrige a RPC já publicada para atender às constraints do schema legado.
-- Salário e encargos técnicos são definidos somente na inserção de novos registros.
