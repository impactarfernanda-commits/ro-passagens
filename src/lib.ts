...
export const motivoLabel:Record<Motivo,string>={ferias:'Férias',folga_campo:'Folga de campo',desligamento:'Desligamento',transferencia_obra:'Transferência de obra',admissao:'Admissão',inicio_obra:'Início na obra',retorno_obra:'Retorno à obra',recesso:'Recesso',viagem_diretoria:'Viagem diretoria',viagem_administrativa:'Viagem administrativa',afastamento:'Afastamento'};
export const formatMotivoLabel=(motivo?:Motivo|null)=>motivo?motivoLabel[motivo]:'Motivo não informado';
