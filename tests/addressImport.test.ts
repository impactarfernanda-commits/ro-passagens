...
test("reconhece cabeçalhos usuais",()=>assert.deepEqual(autoMapHeaders(["NOME FUNCIONÁRIO","ENDERECO","NUM","MUNICÍPIO","ESTADO","C.E.P."]),{nome:0,cep:5,logradouro:1,numero:2,cidade:3,estado:4}));
