...
test("migrations originais mantêm os hashes de origem do combinado",()=>{const sha=(value:string)=>createHash("sha256").update(value.replace(/\r\n/g,"\n")).digest("hex").toUpperCase();assert.equal(sha(migration002),"C28A1AAB29E03ACFEE7DF81D328F3631EB9755EAB80104CB6E50B9A4F5F1BF21");assert.equal(sha(migration003),"5C896D936BCCF5201445B397F448B08F2E14736283B3B3B5CB89FD8C892EA828");});
